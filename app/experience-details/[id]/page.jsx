...
function ExperienceDetails() {
  ...
  // Note: params.id is a string from URL, experienceData ID is integer.
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-8">
              ...
              <div className="prose prose-invert prose-lg max-w-none">
                <p className="text-gray-300 text-base md:text-lg leading-relaxed mb-10 bg-[#111111]/60 p-8 rounded-[2rem] border border-white/[0.08] shadow-2xl">
                  {exp.description}
                </p>
              </div>
            </div>
