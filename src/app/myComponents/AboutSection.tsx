...
const AboutSection = () => {
  return (
    <BackgroundLines
      ...
      className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-blue-950 relative"
    >
      <section id="about" className="py-10 text-white relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <h2 className="text-5xl mt-20 leading-tight font-bold mb-12 text-center bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">
            About Me
          </h2>
