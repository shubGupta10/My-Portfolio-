...
const AboutSection = () => {
  return (
    ...
    >
      <section id="about" className="py-10 text-black dark:text-white relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="flex flex-col-reverse md:flex-row gap-16 md:gap-8 items-center">
            <div className="md:w-2/3 space-y-6">
              <p className="md:text-[1.5rem] mymd:text-[1.3rem] mynew:text-[1.3rem] mysm:text-[1rem] leading-relaxed">
