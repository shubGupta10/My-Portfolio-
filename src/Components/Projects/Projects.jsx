        ...
        <div className="row row-cols-1 row-cols-md-3 g-4 goodlook">
          ...
          <div className="col">
            <div className="card" style={{ width: '80%' }} id="cardNew">
              <img src="src\assets\Images\blogPoint.png" className="card-img-top" alt="Project 1 Image" />
          ...
          <div className="col">
            <div className="card" style={{ width: '80%' }}>
              <img src="src\assets\Images\pinfuence.png" className="card-img-top" alt="Project 5 Image" />
              <div className="card-body">
          ...
          <div className="col">
            <div className="card" style={{ width: '80%' }}>
              <img src="src\assets\Images\Instagram Clone.png" className="card-img-top" alt="Project 3 Image" />
              <div className="card-body">
          ...
          <div className="col">
            <div className="card" style={{ width: '80%' }}>
              <img src="src\assets\Images\Todo.png" className="card-img-top" alt="Project 4 Image" />
              <div className="card-body">
          ...
          <div className="col">
            <div className="card" style={{ width: '80%' }}>
              <img src="src\assets\Images\my-Portfolio.png" className="card-img-top" alt="Project 2 Image" />
              <div className="card-body">
