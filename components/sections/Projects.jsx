                ...
                <div className="flex flex-col">
                    {projectsData.map((project, index) => (
                        <ReviewOnScroll key={index} threshold={0.1}>
                            <div className={`py-4 sm:py-5 group block ${index !== projectsData.length - 1 ? "border-b border-border" : ""}`}>
                                ...
                                <div className="flex flex-row items-center justify-between gap-2 sm:gap-4 mb-0.5">
                                    ...
                                    >
                                        <h3 className="text-lg sm:text-xl font-semibold tracking-tight text-foreground underline group-hover/title:translate-x-1 transition-transform duration-300 underline-offset-4 truncate">
                                ...
                                <p className="text-[15px] sm:text-[16px] text-foreground leading-relaxed max-w-3xl mb-5 mt-4">
