...
function Home() {
  return (
    <>
      <ReviewOnScroll>
        <Section id="home" className="!pb-2 sm:!pb-4">
          <div className="relative z-10 w-full flex flex-col items-start text-left">
            <div className="flex flex-wrap items-center gap-4 mb-4">
              ...
              <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full border border-green-900 bg-green-950 text-green-400">
                ...
                <span className="typo-meta tracking-wide">
                  Available for freelance
                </span>
              </div>
            </div>

            <div className="typo-body max-w-2xl space-y-4 mt-2">
              <p>
                I'm a Full Stack Developer with experience building complete web applications, custom backends, and AI integrations for startups and businesses.
              </p>
              <p>
                Want to know more? <Link href="/projects" className="font-medium text-foreground transition-colors hover:text-muted-foreground underline underline-offset-4">View my work</Link> or <Link href="/services" className="font-medium text-foreground transition-colors hover:text-muted-foreground underline underline-offset-4">explore my services</Link>.
              </p>
            </div>
          </div>
        </Section>
      ...
      <ReviewOnScroll>
        <Section className="!pt-2 sm:!pt-4 pb-4 text-left">
          <h2 className="typo-h2 mb-4">
            Professional Work
          </h2>
          <div className="typo-body max-w-3xl space-y-4">
            <p>
              I specialize in building custom web applications and scalable backends. Currently, I'm engineering community platforms as a Full Stack Engineer at
            ...
            <p>
              Alongside this, I work closely with clients as a Freelance Developer. I have delivered production-ready web applications for
              ...
              . For more details about my background, check out my <Link href="/experience" className="underline decoration-border hover:decoration-muted-foreground transition-colors font-medium">experience</Link>.
            </p>
          </div>
        </Section>
      </ReviewOnScroll>
