  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex justify-between items-start mb-5">
        <div>
          <h3 className="typo-h2 tracking-tight group-hover:text-primary transition-colors duration-300 mb-2">
            {exp.position}
          </h3>
          <div className="flex items-center gap-3">
            <span className="text-primary font-medium text-[17px]">{exp.company}</span>
            <span
      ...
      <p className="typo-meta mb-6 relative z-10 !font-medium">
        {exp.duration}
      </p>

      <p className="typo-body mb-8 flex-grow relative z-10 line-clamp-3">
